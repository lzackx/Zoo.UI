...
@interface ZooHierarchyPickerView ()
...
@implementation ZooHierarchyPickerView
...
#pragma clang diagnostic pop
    for (UIWindow *window in [[[ZooHierarchyHelper shared] allWindowsIgnorePrefix:@"Zoo"] reverseObjectEnumerator]) {
