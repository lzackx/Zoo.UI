...
@interface ZooColorPickMagnifyLayer ()

@property (nonatomic) struct CGPath *gridCirclePath;

@end

@implementation ZooColorPickMagnifyLayer
    ...
    for (j=0; j<kGridNum; j++) {
        for (i=0; i<kGridNum; i++) {
            ...
            if (self.pointColorBlock) {
                ...
                gridColor = [UIColor zoo_colorWithHexString:pointColorHexString];
            }
